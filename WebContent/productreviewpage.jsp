...
<a href = "ReviewUpdateForm.do?no=${vo.r_no }&r_title=${vo.r_title}&r_content=${vo.r_content}&p_no=${param.p_no}">수정</a><br>
<a href = "ReviewDelete.do?no=${vo.r_no }&p_no=${param.p_no}">삭제</a>
</c:when>
</c:choose>
</div>
